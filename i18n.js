const translations = {
    zh: {
        ...
        "cart-empty": "购物车为空",
        "cart-click-detail": "点击查看详情",
        "cart-open-detail-aria-template": "查看《{title}》详情",
        ...
        "history-open-btn": "再次查看",
        "history-remove-title": "移除记录",
        "history-clear-success": "浏览历史已清空",
        "logout-success-notice": "已退出登录，正在返回首页...",
        ...
        "book-detail-close-aria": "关闭详情页",
        "related-books-title": "相关图书",
        "related-books-subtitle": "基于作者、分类与标签为你推荐",
        "related-book-reason-default": "图书属性相近，值得继续浏览",
        "related-book-reason-same-author": "同作者作品",
        "related-book-reason-shared-tags": "共同标签：{tags}",
        "related-book-reason-same-category": "同属“{category}”分类",
        "related-book-reason-same-publisher": "同出版社相关图书",
        "related-book-reason-close-price": "价格区间接近，适合继续比较",
        "related-book-reason-general": "相关图书推荐",
        "related-book-favorite-aria": "收藏图书",
        "related-book-add-cart-aria": "加入购物车",
        "order-detail-close-aria": "关闭订单详情",
        "order-review-status-approved": "该评价已发布",
        "order-review-status-pending": "该评价正在人工审核中，审核通过后会公开展示",
        "order-review-status-rejected": "该评价未通过审核",
        "order-review-status-hidden": "该评价当前不可见",
        "order-review-status-empty": "尚未提交评价",
        "order-review-missing-bookid": "该商品缺少 bookId，无法关联评价",
        "order-review-hint-reviewed": "已评价，可修改，可补充图片/视频",
        "order-review-hint-prompt": "请为该图书评分，可选文字和图片/视频",
        "order-review-hint-disabled": "订单未收货，暂不可评价",
        "order-review-comment-placeholder": "可选：写下你的评价（最多 300 字）",
        "order-review-media-pick-btn": "选择图片/视频",
        "order-review-media-clear-btn": "清空附件",
        "order-review-media-status-added": "已添加 {count}/{max} 个附件",
        "order-review-media-status-empty": "支持图片/视频上传，最多 {max} 个附件",
        "order-review-dropzone-title": "拖拽图片或视频到这里",
        "order-review-dropzone-subtitle": "也可点击上方按钮直接选择，无需单独上传到存储桶",
        "review-media-gallery-title": "评价附件预览",
        "review-media-gallery-close-aria": "关闭大图预览",
        "review-media-open-label-template": "查看{label}",
        "common-prev": "上一张",
        "common-next": "下一张"
    },
    en: {
        ...
        "cart-click-detail": "Tap to view details",
        "cart-open-detail-aria-template": "View details for \"{title}\"",
        ...
        "history-open-btn": "View Again",
        "history-remove-title": "Remove record",
        "history-clear-success": "Browsing history cleared",
        "logout-success-notice": "Logged out. Returning to the home page...",
        ...
        "book-detail-close-aria": "Close details",
        "related-books-title": "Related Books",
        "related-books-subtitle": "Recommended based on author, category, and tags",
        "related-book-reason-default": "This book is similar in style and worth exploring next.",
        "related-book-reason-same-author": "More books by the same author",
        "related-book-reason-shared-tags": "Shared tags: {tags}",
        "related-book-reason-same-category": "Also in the \"{category}\" category",
        "related-book-reason-same-publisher": "Related books from the same publisher",
        "related-book-reason-close-price": "Similar price range for easy comparison",
        "related-book-reason-general": "Related book recommendation",
        "related-book-favorite-aria": "Add book to favorites",
        "related-book-add-cart-aria": "Add book to cart",
        "order-detail-close-aria": "Close order details",
        "order-review-status-approved": "This review is published",
        "order-review-status-pending": "This review is under manual moderation and will be published after approval",
        "order-review-status-rejected": "This review did not pass moderation",
        "order-review-status-hidden": "This review is currently hidden",
        "order-review-status-empty": "No review submitted yet",
        "order-review-missing-bookid": "This item is missing a bookId and cannot be linked to a review",
        "order-review-hint-reviewed": "Already reviewed. You can edit it or add images/videos.",
        "order-review-hint-prompt": "Please rate this book. Text and images/videos are optional.",
        "order-review-hint-disabled": "The order has not been received yet, so reviewing is unavailable.",
        "order-review-comment-placeholder": "Optional: write your review here (up to 300 characters)",
        "order-review-media-pick-btn": "Choose Images/Videos",
        "order-review-media-clear-btn": "Clear Attachments",
        "order-review-media-status-added": "Added {count}/{max} attachments",
        "order-review-media-status-empty": "Images/videos supported, up to {max} attachments",
        "order-review-dropzone-title": "Drag images or videos here",
        "order-review-dropzone-subtitle": "Or click the button above to choose files directly, no separate bucket upload needed",
        "review-media-gallery-title": "Review Attachment Preview",
        "review-media-gallery-close-aria": "Close gallery preview",
        "review-media-open-label-template": "View {label}",
